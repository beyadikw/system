...
- **صفحة تقديم الطلبات للجهات الخارجية (عامة، بلا تسجيل دخول):** `https://رابطك.onrender.com/submit.html` — انشر هذا الرابط للجهات الراغبة بطلب رعاية، وستظهر طلباتها مباشرةً في بوابة المنسّق.
